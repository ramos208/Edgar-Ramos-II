...
class MainWindow(QMainWindow):
    def __init__(self, widget):
        ...
        self.file_menu_test = self.menu.addMenu("Test")
        ...
        exit_action2 = QAction("Test Exit", self)
        exit_action2.setShortcut("Ctrl+Q")
        exit_action2.triggered.connect(self.exit_app)

        self.file_menu.addAction(exit_action)
        self.file_menu_test.addAction(exit_action2)
